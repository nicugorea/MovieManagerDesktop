...
public class MovieTileVBox extends VBox
{
	...
	private void createMainVBox()
	{
		...
		String styles = String.format("-fx-background-color: #fff;" + "-fx-background-radius: %d ;",
		        this.TILE_RADIUS);
	...
	private VBox createThumbnail()
	{
		...
		try
		{
			...
			String styles = "-fx-shape:\"" + this.getPathForRoundedRect(this.TILE_WIDTH,
			        this.TILE_HEIGHT, this.TILE_RADIUS, this.TILE_RADIUS, 0, 0) + "\";";
	...
	private String getPathForRoundedRect(final float width, final float height, final float tl,
	        final float tr, final float br, final float bl)
	{
		return "M 0 " + tl + " A " + tl + " " + tl + " 0 0 1 " + tl + " 0" + " L " + (width - tr)
		        + " 0" + " A " + tr + " " + tr + " 0 0 1 " + width + " " + tr + " L " + width + " "
		        + (height - br) + " A " + br + " " + br + " 0 0 1 " + (width - br) + " " + height
		        + " L " + bl + " " + height + " A " + bl + " " + bl + " 0 0 1 0 " + (height - bl)
		        + " Z";
	}
